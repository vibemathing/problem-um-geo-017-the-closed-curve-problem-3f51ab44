...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-geo-017-the-closed-curve-problem-3f51ab44-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GEO-017"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-geo-017-the-closed-curve-problem-3f51ab44-v1",
      "problem_contract_sha256": "0ce268abf36ffd5d2276f82830bd2fbc3a6e915b6a5425bae92c9a41cd83e0e2",
      "problem_id": "problem:um-geo-017-the-closed-curve-problem-3f51ab44",
      "route_id": "route:um-geo-017-the-closed-curve-problem-3f51ab44-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-geo-017-the-closed-curve-problem-3f51ab44-source-fidelity-01",
      "graph_id": "graph:um-geo-017-the-closed-curve-problem-3f51ab44-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-geo-017-the-closed-curve-problem-3f51ab44-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-geo-017-the-closed-curve-problem-3f51ab44-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What are necessary and sufficient conditions for an integral curve defined by two periodic functions to be closed?"
          },
          "statement_sha256": "abb475cb5116785cdfd012e8fd65f1b526b67752b0d0a9ba689ff01a348df4fc"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-geo-017-the-closed-curve-problem-3f51ab44-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-geo-017-the-closed-curve-problem-3f51ab44-root",
      "route_id": "route:um-geo-017-the-closed-curve-problem-3f51ab44-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-geo-017-b98761df0a54",
        "url": "https://www.unsolvedmath.com/problems/GEO-017"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
